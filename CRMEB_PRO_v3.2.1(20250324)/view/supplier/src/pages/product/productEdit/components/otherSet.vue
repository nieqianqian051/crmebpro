<template>
  <div>
    ...
    <FormItem label="商品参数：" prop="">
      ...
      <span class="addClass" v-if="!formValidate.specs.length" @click="addSpecs">自定义</span>
    </FormItem>
    <FormItem v-if="formValidate.specs_id || formValidate.specs.length">
      <el-table
        border
        size="small"
...
export default {
  ...
  methods: {
    ...
    addSpecs() {
      ...
      console.log(this.formValidate.specs);
    },
    customMessBtn(e) {
      if (!e) {
