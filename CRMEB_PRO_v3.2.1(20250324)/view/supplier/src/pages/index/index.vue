    ...
    <Row :gutter="24" class="ivu-mt">
      <Col :xl="12" :lg="12" :md="24" :sm="24" :xs="24">
        <Card :bordered="false" dis-hover>
          ...
          <echarts-new
            :option-data="circularData"
            :styles="style"
            height="100%"
            width="100%"
            v-if="circularData && !orderNum"
          ></echarts-new>
        </Card>
      </Col>
      <Col :xl="12" :lg="12" :md="24" :sm="24" :xs="24">
        <Card :bordered="false" dis-hover>
          ...
          <echarts-new
            :option-data="circularDataType"
            :styles="style"
            height="100%"
            width="100%"
            v-if="circularDataType && !typeNum"
          ></echarts-new>
        </Card>
      </Col>
    </Row>
...
export default {
  ...
  methods: {
    ...
    getOrderType() {
      orderType({ data: this.formValidate.data })
        .then((res) => {
          let data = res.data.list,
            bingData = res.data.bing_data;
    ...
    circularChart() {
      orderChannel({ data: this.formValidate.data })
        .then((res) => {
          let data = res.data.bing_data,
            list = res.data.list;
    ...
    trends() {
      operateApi({ data: this.formValidate.data })
        .then(async (res) => {
